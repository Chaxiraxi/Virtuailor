...
>>Virtuailor now supports IDA versions from 7.0 to 9.2. If you are using IDA versions older than 7.4 you will need to switch to branch beforeIDA-7.4. The master branch supports IDA 9.x (current).
